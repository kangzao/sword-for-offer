...
public class GPProxy {
  ...
  private static String generateSrc(Class<?>[] interfaces) {
    ...
    sb.append("package com.jep.github.designpattern.proxy.dynamic;" + ln);
    sb.append("import com.jep.github.designpattern.proxy.staticproxy.Person;" + ln);
    ...
    for (Method m : interfaces[0].getMethods()) {
      ...
      sb.append(
          "public " + m.getReturnType().getName() + " " + m.getName() + "(" + paramNames.toString()
              + ") {" + ln);
      sb.append("try{" + ln);
      ...
      sb.append((hasReturnValue(m.getReturnType()) ? "return " : "") + getCaseCode(
          "this.h.invoke(this,m,new Object[]{" + paramValues + "})", m.getReturnType()) + ";" + ln);
